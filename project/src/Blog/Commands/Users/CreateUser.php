...
// Все команды должны быть наследниками
// класса Symfony\Component\Console\Command\Command
class CreateUser extends Command
{
    ...
    protected function configure(): void
    {
        ...
        ->addArgument(
            ...
            ->addArgument('last_name', InputArgument::REQUIRED, 'Last name')->addArgument('username', InputArgument::REQUIRED, 'Username')->addArgument('password', InputArgument::REQUIRED, 'Password');
    }
